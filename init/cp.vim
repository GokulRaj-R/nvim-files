...
" Make ith Input File
nnoremap <A-1> :tabe %:rin_1<bar>:%d<bar>:put +<CR><bar>:wq<CR>
nnoremap <A-2> :tabe %:rin_2<bar>:%d<bar>:put +<CR><bar>:wq<CR>
nnoremap <A-3> :tabe %:rin_3<bar>:%d<bar>:put +<CR><bar>:wq<CR>
nnoremap <A-4> :tabe %:rin_4<bar>:%d<bar>:put +<CR><bar>:wq<CR>
nnoremap <A-5> :tabe %:rin_5<bar>:%d<bar>:put +<CR><bar>:wq<CR>
nnoremap <A-6> :tabe %:rin_6<bar>:%d<bar>:put +<CR><bar>:wq<CR>
nnoremap <A-7> :tabe %:rin_7<bar>:%d<bar>:put +<CR><bar>:wq<CR>
nnoremap <A-0> :vsp %:rin_0<CR>
